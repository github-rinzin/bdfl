...
class OutletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outlet" do
    assert_difference('Outlet.count') do
      post outlets_url, params: { outlet: { location: @outlet.location, name: @outlet.name } }
    end
  ...
  test "should update outlet" do
    patch outlet_url(@outlet), params: { outlet: { location: @outlet.location, name: @outlet.name } }
